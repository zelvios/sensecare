<script lang="ts">
  ...
  const styles: Record<Variant, string> = {
    ...
    'accent-soft':
      'bg-surface-0 text-text shadow-sm shadow-crust/50 ring-1 ring-surface-1 hover:bg-accent/10 hover:text-accent hover:ring-accent/40',
    'ok-soft':
      'bg-surface-0 text-text shadow-sm shadow-crust/50 ring-1 ring-surface-1 hover:bg-ok/10 hover:text-ok hover:ring-ok/40'
  };
</script>
...
<button
  ...
  duration-200 hover:-translate-y-px focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:outline-none
  active:translate-y-0 active:shadow-sm disabled:opacity-60 disabled:hover:translate-y-0
